...
xlabel('alpha');
ylabel('L/D');
outputFilePath = [folderPath caseref '_L_over_D_vs_alpha.png'];
saveas(gcf, outputFilePath);

figure('Position', [100, 100, 1200, 400]);
plot(xk, yk);
title('Aerofoil shape');
outputFilePath = [folderPath caseref '_aerofoil_shape.png'];
saveas(gcf, outputFilePath);
...
outputFilePath = [folderPath caseref '_cpu.png'];
saveas(gcf, outputFilePath);
